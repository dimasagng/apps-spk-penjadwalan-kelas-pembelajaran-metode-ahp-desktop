...
public class FormSubKriteria extends Form {

    private final ServiceSubKriteria servis = new SubKriteriaDAO();
    private final TabModSubKriteria tblModel = new TabModSubKriteria();
    ...
    public FormSubKriteria() {
        ...
        private JPanel setInfo() {
            ...
            JLabel lbTitle = new JLabel("Data Sub Kriteria");
    ...
    private void loadData() {
        List<SubKriteria> list = servis.getData();
    ...
    private void searchData() {
        ...
        List<SubKriteria> list = servis.searchData(keyword);
        tblModel.setData(list);
        tblData.setModel(tblModel);
    }
    ...
    private void insertData() {
        ...
        ModalDialog.showModal(this,
                new SimpleModalBorder(new FormInputSubKriteria(null, this),
                        "Add Sub Kriteria"), option, "Form Input");
    }
    
    private void updateData() {
        int row = tblData.getSelectedRow();
        if (row != -1) {
            SubKriteria model = tblModel.getData(row);
            Option option = ModalDialog.createOption();
            ModalDialog.showModal(this,
                    new SimpleModalBorder(new FormInputSubKriteria(model, this),
                            "Update Sub Kriteria"), option, "Form Update");
        } else {
                    ...
                    new MessageModal(
                            ...
                            (controller, action) -> {
                                if (action == SimpleModalBorder.YES_OPTION) {
                                    ...
                                    servis.deleteData(modelSubKriteria);
