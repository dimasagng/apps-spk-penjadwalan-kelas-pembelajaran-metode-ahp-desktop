...
public class FormUser extends Form {
    ...
    private void searchData() {
        ...
        List<User> list = servis.searchData(keyword);
        tblModel.setData(list);
        tblData.setModel(tblModel);
    }
    ...
    private void insertData() {
        ...
        ModalDialog.showModal(this,
                new SimpleModalBorder(new FormInputUser(null, this),
                        "Add User"), option, "Form Input");
    }
    ...
    if (row != -1) {
        ...
        Option option = ModalDialog.createOption();
        ModalDialog.showModal(this,
                new SimpleModalBorder(new FormInputUser(model, this),
                        "Update User"), option, "Form Update");
    } else {
